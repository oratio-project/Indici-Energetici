 ...
 */
Ext.define('Index.view.user.app.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        Index.view.user.app.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        Index.view.user.app.PortalDropZone.superclass.unreg.call(this);
    }
});
