...
Ext.define('Index.view.admin.BalanceItemsList', {
	extend : 'Ext.grid.Panel',
	alias : 'widget.balanceitemslist',
	id:'balanceitemslist',
	...
	columns : [{
		...
		items : [{
			...
			handler : function (grid, rowIndex, colIndex){
				//fire event
				this.fireEvent('balance_edit', grid, rowIndex,colIndex);
			}
		}]
	},{
		xtype:'actioncolumn',
		...
		items :[{
			...
			handler : function (grid, rowIndex, colIndex){
				//fire event
				this.fireEvent('balance_delete', grid, rowIndex,colIndex);
			}
		}]
	}]
