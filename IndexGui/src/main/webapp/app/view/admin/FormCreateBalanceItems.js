...
Ext
		.define(
				'Index.view.admin.FormCreateBalanceItems',
				{
					extend : 'Ext.form.Panel',
					alias : 'widget.formcreatebalance',
					id : 'formcreatebalanceitems',
					bodyPadding : 5,
					// width : 600,
					hidden : true,
					padding : 5,
					title : i18n.t('admin.add_balance_item'),
					layout : {
						type : 'table',
						columns : 2
					},
