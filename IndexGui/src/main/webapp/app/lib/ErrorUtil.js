...
Ext.define('Index.lib.ErrorUtil', {
	handle : function(proxy, response, operation) {
		console.log("Handle error for response " + response);

		if (response.status = 500) {
			Ext.Msg.alert(i18n.t("error.title"), i18n.t("error.internal_server_error"));
		}
	}
});
