...
/**
 * <p>
 * <b>Name:</b> FunctionNode
 * </p>
 * <p>
 * <b>Description:</b> This node is used to evaluate every kind of function with
 * a single parameter, like abs(...) or sin(...)
 * </p>
 * <p>
 * <b>Date:</b> 08/dic/06 <b>Time:</b> 16:31:14
 * </p>
 * 
...
public class FunctionNode implements ExpressionNode {
	...
	public static final String[] FUNCTIONS = new String[] { "-", "sin", "cos", "tan", "asin", "acos", "atan", "sinh", "cosh", "tanh",
			"asinh", "acosh", "atanh", "ln", "log", "abs", "rand", "sqrt", "erf", "erfc", "gamma", "exp", "cot", "log2" };
	/** Child node */
	 ...
	 * @param function
	 *            function to be evaluated. This is the index in
	 *            <code>FUNCTIONS</code> array
	 ...
	 * (non-Javadoc)
	 * 
	 * @see jmt.engine.math.parser.ExpressionNode#setVariable(java.lang.String,
	 * double)
	 */
