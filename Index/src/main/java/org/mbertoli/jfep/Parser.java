 ...
 * </p>
 * <p>
 * <b>Description:</b> Simple Java arithmetic expression parser and ELL(1)
 * grammar syntactical analizer and evaluator. Parser supports detection of
 * implicit multiplication when a constant is followed by a variable or
 * function.
 * </p>
 * <p>
 * <b>Grammar:</b><br>
 ...
 * </p>
 * <p>
 * <b>Date:</b> 08/dic/06 <b>Time:</b> 13:58:28
 * </p>
 * 
...
public class Parser {
	 ...
	 *            Input string to be analyzed
	 * @param error
	 *            if true, an exception is raised when value is get from a
	 *            variable not initialized. If false, that variable is
	 *            considered as zero.
	 */
	...
	/**
	 * Converts input string in a character array and removes unsupported
	 * characters
	 * 
	 * @param str
	 *            input string
	...
	protected char[] convertInput(String str) {
		...
		char[] output = new char[input.length + 1]; // One more space for
													// terminator
	 ...
	 * @throws ParseError
	 *             if parsed input string was malformed
	 */
	...
	private ExpressionNode U() {
		...
		case NUM:
			double n = cc.number;
			int constPosition = cc.position; // Position if this is a built-in
												// constant
			cc = parse();
			if (constPosition >= 0)
	 ...
	 * 
	 * @param name
	 *            name of the variable to be set (case sensitive)
	 * @param value
	 ...
	 *             if one variable was not initialized and parser was created
	 *             with <code>error = true</code>
	...
	/**
	 * Returns a string rappresentation of parsed expression with the right
	 * parentesis
	 * 
	 * @return a string rappresentation of parsed expression with the right
	 *         parentesis
	 * @throws ParseError
	 *             if parsed input string was malformed
	 */
